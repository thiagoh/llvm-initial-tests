...
@my_name_is_foo = private unnamed_addr constant [15 x i8] c"my name is foo\00", align 1
...
for.body:                                         ; preds = %for.cond
  %call_1 = call i32 @_ZN6Person6getAgeEv(%class.Person* %person1)
  %call_2 = call i32 @_ZN6Person6getAgeEv(%class.Person* %person1)
  %call_4 = getelementptr inbounds [15 x i8], [15 x i8] * @my_name_is_foo, i32 0, i32 0
  %call_3 = call double @c_puts(i8* %call_4)
  %call = add i32 %call_1, %call_2
